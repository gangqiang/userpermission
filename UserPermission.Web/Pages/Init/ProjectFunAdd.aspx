<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectFunAdd.aspx.cs"
    Inherits="UserPermission.Web.Pages.Init.ProjectFunAdd" %>
...
<body>
    ...
    <table class="listtable">
        ...
        <tr id="trPageUrl">
            ...
            <td>
                <asp:TextBox ID="txtFMPageUrl" CssClass="text" MaxLength="50" runat="server" Width="260px"></asp:TextBox>
