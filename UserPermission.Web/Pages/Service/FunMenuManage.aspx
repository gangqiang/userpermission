<%@ Page Title="系统功能菜单管理" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="FunMenuManage.aspx.cs" Inherits="UserPermission.Web.Pages.Service.FunMenuManage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        tr.drawNode = function (key) {
            ...
            arrayHtml.push("</div>");
            arrayHtml.push("<div style='float:left; width:50%;text-align:left;border-right:1px solid #CCC;' title='" + node.Text[3] + "'>");
            arrayHtml.push("&nbsp;&nbsp;" + node.Text[3]);
            arrayHtml.push("</div>");
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset>
        <legend>系统功能菜单管理</legend>
        <table class="table">
            <tr>
                <td>
                    <asp:Label ID="lblTip" runat="server" Visible="false" Text="在下面列表进行系统菜单的维护"></asp:Label>
                    <span id="sProject" style="display: none;">所属项目：
    ...
    <div>
        <table style="margin: 0 10px; width: 99.5%; display: none;">
            <tr>
                <td style="width: 80%;">
        ...
        <div class="div_head">
            ...
            <%--  <div style="float: left; width: 35%; text-align: center; border-right: 1px solid #CCC;
                color: black; padding-top: 2px; font-weight: bold;">
                链接地址
            </div>--%>
    ...
    <script type="text/javascript">
        ...
        function Add(id) {
            Tw.Win.OpenWithParam({ oid: this, cover: true, rang: true, width: 520, height: 350, title: '新增项目功能菜单', page: "FunMenuEdit.aspx?type=add&fmid=" + id });
        }
        function Edit(id) {
            Tw.Win.OpenWithParam({ oid: this, cover: true, rang: true, width: 520, height: 350, title: '修改项目功能菜单', page: "FunMenuEdit.aspx?type=edit&fmid=" + id });
        }
        ...
        function Del(id) {
            if (window.confirm("你确定要删除吗？")) {
                ...
                //判断能否被删除
                var url = "../../Handler/AjaxHandler.ashx?action=IfCFunDel&fmid=" + id + "&s=" + Math.random();
                $.get(url, function (msg) {

                    if (msg == "0") {
                        $.get("../../Handler/AjaxHandler.ashx?action=DelCFunMenu&fmid=" + id + "&s=" + Math.random(), function (msg2) {
        ...
        function LoadFun() {
            ...
            var url = "../../Handler/AjaxHandler.ashx?action=LoadCFunMenu&projectid=" + pid + "&s=" + Math.random();
            $.get(url, function (msg) {
